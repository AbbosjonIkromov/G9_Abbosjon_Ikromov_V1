...
namespace ModulExam5
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Interceptor iwlayotganini tekwirish
            //var lastProduct = context.Products.FirstOrDefault(r => r.ProductId == 20);
            //if (lastProduct is not null)
            //{
            //    lastProduct.ProductName = "Banana";
            //    context.SaveChanges();
            //}
            var result =  productService.DeleteProduct(23);
